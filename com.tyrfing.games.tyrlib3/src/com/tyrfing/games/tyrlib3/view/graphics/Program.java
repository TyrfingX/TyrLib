...
public class Program {
	...
	public static void setInUse(Program inUse) {
		Program.inUse = inUse;
	}
	
	public static Program getInUse() {
		return inUse;
	}
	...
	public String[] getBindAttributes() {
		return bindAttributes;
	}
	
	public void setBindAttributes(String[] bindAttributes) {
