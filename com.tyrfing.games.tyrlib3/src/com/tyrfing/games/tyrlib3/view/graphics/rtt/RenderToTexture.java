package com.tyrfing.games.tyrlib3.view.graphics.rtt;
...
import com.tyrfing.games.tyrlib3.view.graphics.renderer.RenderableSceneObject;
...
public class RenderToTexture {
	...
	public RenderToTexture(Vector2F size, Precision precision) {
	...
	public Texture render(String textureName) {
		...
		if (tex == null) {
			...
			tex.size = new Vector2F(width, height);
