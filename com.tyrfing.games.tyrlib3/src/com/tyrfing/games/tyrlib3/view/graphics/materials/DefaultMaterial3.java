...
public class DefaultMaterial3 extends LightedMaterial {
	...
	public float[] createVertexData(Vector3F[] points, float[] uvCoords, short[] drawOrder) {
	...
	public Material copy() {
		DefaultMaterial3 material = new DefaultMaterial3(textureName, repeatX, repeatY, colors, isAnimated());
	...
	public Vector2F getRepeat() {
		return new Vector2F(repeatX, repeatY);
	}
