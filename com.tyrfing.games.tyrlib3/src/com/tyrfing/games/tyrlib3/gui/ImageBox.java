...
import com.tyrfing.games.tyrlib3.graphics.materials.TexturedMaterial;
...
import com.tyrfing.games.tyrlib3.graphics.renderer.TextureRegion;
...
public class ImageBox extends Window {
	...
	protected ImageBox(String name, Vector2F pos, int textureHandle, Vector2F size) {
		super(name, size);
