package com.tyrfing.games.tyrlib3.graphics.text.programs;
...
import com.tyrfing.games.tyrlib3.graphics.text.AttribVariable;
...
public class BatchTextProgram extends Program {
	...
	private static final String fragmentShaderCode =
			...
			+ "{                              \n"
			+ 
				"   gl_FragColor = vec4(1.0,1.0,1.0,texture2D(u_Texture, v_TexCoordinate).a) * u_Color;\n" // texture is grayscale so take only grayscale value from  
