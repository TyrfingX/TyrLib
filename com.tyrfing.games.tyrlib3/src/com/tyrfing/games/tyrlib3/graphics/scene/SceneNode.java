...
public class SceneNode implements Serializable {
	...
	protected Vector3F absolutePos = new Vector3F();
	...
	protected Vector3F absoluteScale = new Vector3F(1,1,1);
	...
	public Vector3F getAbsolutePos() {
		...
		if (parent != null) {
			Vector3F.add(absolutePos, parent.getAbsolutePos(), absolutePos);
		} 
	...
	public Vector3F getCachedAbsolutePos() {
		return new Vector3F(absolutePos);
	}
	
	public Vector3F getCachedAbsolutePosVector() {
		return absolutePos;
	}
	...
	public void setAbsolutePos(Vector3F pos) {
		Vector3F newPos = pos;
		if (parent != null) {
	...
	public Vector3F getCachedAbsoluteScale() {
		return absoluteScale;
	}
	...
	public void setAbsoluteScale(Vector3F scale) {
		Vector3F newScale = scale;
		if (parent != null) {
			Vector3F parentScale = parent.getAbsoluteScale();
	...
	public void setRelativeScale(Vector3F scale) {
	...
	public SceneNode createChild(Vector3F pos) {
	...
	public SceneNode createChild() {
		return createChild(new Vector3F());
	}
	...
	public void update(Quaternion parentRot, Vector3F parentScale, float[] parentTransform) {
		if (update) {			
