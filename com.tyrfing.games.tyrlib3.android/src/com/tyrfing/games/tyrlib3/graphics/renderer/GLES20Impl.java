...
import com.tyrfing.games.tyrlib3.graphics.renderer.GLImpl;
import com.tyrfing.games.tyrlib3.graphics.renderer.TyrGL;

import android.opengl.GLES20;

public class GLES20Impl implements GLImpl {
	...
	public GLES20Impl() {
		...
		TyrGL.GL_TEXTURE4 = GLES20.GL_TEXTURE4;
		...
		TyrGL.GL_ONE_MINUS_SRC_COLOR = GLES20.GL_ONE_MINUS_SRC_COLOR;
		...
		TyrGL.GL_COLOR_ATTACHMENT1 = GLES20.GL_COLOR_ATTACHMENT0;
		...
		TyrGL.GL_RGBA32F = GLES20.GL_RGBA4;
		TyrGL.GL_RGBA16F = GLES20.GL_RGBA4;
		TyrGL.GL_RGB = GLES20.GL_RGB;
		TyrGL.GL_UNSIGNED_INT = GLES20.GL_UNSIGNED_INT;
		TyrGL.GL_RENDERBUFFER = GLES20.GL_RENDERBUFFER;
		TyrGL.GL_MULTISAMPLE = 0;
		TyrGL.GL_TEXTURE_2D_MULTISAMPLE = 0;
		TyrGL.GL_TRUE = GLES20.GL_TRUE;
		TyrGL.GL_FRAMEBUFFER_COMPLETE = GLES20.GL_FRAMEBUFFER_COMPLETE;
	...
	public void glTexImage2DMultisample(int target, int samples,
		...
		//GLES20.glTexImage2D(target, samples, internalformat, width, height, border, format, type, pixels);
	}
	...
	@Override
	public void glBlitFramebuffer(int srcX, int srcY, int srcWidth,
