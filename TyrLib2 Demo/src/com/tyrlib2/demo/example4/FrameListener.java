...
public class FrameListener implements IFrameListener {
	...
	public void onSurfaceCreated() {
		...
		TextureManager.getInstance().createTexture("DUST", com.tyrlib2.demo.R.drawable.dust);
		
		/* create a an appropriate factory for creating a particle system from an XML file */
		XMLParticleSystemFactory particleSystemFactory = new XMLParticleSystemFactory("particle/particle1.xml");
		...
		SceneManager.getInstance().getRenderer().addRenderable((BoundedSceneObject)system);
	}
