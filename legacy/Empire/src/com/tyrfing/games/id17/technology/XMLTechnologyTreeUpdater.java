...
public class XMLTechnologyTreeUpdater {
	...
	public XMLTechnologyTreeUpdater(String source) {
		this.source = source;
	}
	
	public void update(TechnologyTree tree) {
		this.tree = tree;
	...
	private void parseTech() throws XmlPullParserException, IOException {
		...
		tree.techs[currentTech].update(	name, scienceMax, funds, pre, researchEffsDesc, discoverEffsDesc, 
										researchEffs, discoverEffs, iconPos);
