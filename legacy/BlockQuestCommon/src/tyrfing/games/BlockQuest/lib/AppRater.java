...
public class AppRater {
    ...
    public static void showLikeDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        dialog.setTitle("What do you think about our app?");
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        tv.setText("Would you be so kind as to rate our app in the market?");
        tv.setWidth(300);
